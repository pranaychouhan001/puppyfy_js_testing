...
function TopbarHome({ onIconClick, onIconClickMobile, onCreatePostClick }) {
  return (
    <nav className="topbar">
      <div className="container nav-container">
        ...
        <div className="setting-icons">
          <span className="notification-top" onClick={onCreatePostClick}>
            <h2 className="top-add-icon">
              <BiImageAdd />
            </h2>
          </span>
          <span
          ...
          <span
            className="notification-top mobile-view"
            onClick={() => onIconClickMobile("messages")}
          >
            <h2 className="top-notification-icon">
              <TiMessages />
            </h2>
